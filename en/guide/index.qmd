...
The site's source code and all its content are openly published in its [GitHub repository](https://github.com/narineneoldu/narineneoldu.github.io). All of the contribution paths below require a **free GitHub account**; the next section explains how to create one.

## Ways to contribute — at a glance

| What would you like to do? | Where to go |
|---|---|
| Request that a specific photo be added to the gallery | [Issues](https://github.com/narineneoldu/narineneoldu.github.io/issues) |
| Request that a specific blog article be added to the site | [Issues](https://github.com/narineneoldu/narineneoldu.github.io/issues) |
| Report an error, gap or incorrect information | [Issues](https://github.com/narineneoldu/narineneoldu.github.io/issues) |
| Exchange ideas, debate or ask a question on a topic | [Discussions](https://github.com/narineneoldu/narineneoldu.github.io/discussions) |
...
The [Issues page](https://github.com/narineneoldu/narineneoldu.github.io/issues) is where concrete requests and error reports are made.
...
1. Open the [Issues page](https://github.com/narineneoldu/narineneoldu.github.io/issues).
...
The [Discussions page](https://github.com/narineneoldu/narineneoldu.github.io/discussions) is for open-ended conversations. If you do not have a concrete *request* or *error report* but want to share a thought, ask a question, or comment on something, this is the right place.
...
1. Open the [Discussions page](https://github.com/narineneoldu/narineneoldu.github.io/discussions).
...
If you get stuck at any step or aren't sure what to do, feel free to open a question in the [Discussions](https://github.com/narineneoldu/narineneoldu.github.io/discussions) section. Every question and every piece of feedback helps the archive become more complete.
